...
type GymtrainerController struct {
	controllers.Controller
}

func (c *GymtrainerController) Read(id int64) {
    
    
	conn := c.NewConnection()

	manager := models.NewGymtrainerManager(conn)
	item := manager.Get(id)
...
func (c *GymtrainerController) Index(page int, pagesize int) {
...
func (c *GymtrainerController) Count() {
...
func (c *GymtrainerController) Insert(item *models.Gymtrainer) {
...
func (c *GymtrainerController) Insertbatch(item *[]models.Gymtrainer) {  
...
func (c *GymtrainerController) Update(item *models.Gymtrainer) {
...
func (c *GymtrainerController) Delete(item *models.Gymtrainer) {
...
func (c *GymtrainerController) Deletebatch(item *[]models.Gymtrainer) {
