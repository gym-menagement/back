...
func (c *TermController) Index(page int, pagesize int) {
    ...
    _daytype := c.Geti64("daytype")
    if _daytype != 0 {
        args = append(args, models.Where{Column:"daytype", Value:_daytype, Compare:"="})    
    }
    _name := c.Get("name")
    if _name != "" {
...
func (c *TermController) Insertbatch(item *[]models.Term) {  
...
func (c *TermController) Deletebatch(item *[]models.Term) {
