...
func (p *InquiryManager) GetQuery() string {
    ...
    ret.WriteString("select iq_id, iq_user, iq_gym, iq_type, iq_title, iq_content, iq_status, iq_answer, iq_answeredby, iq_answereddate, iq_createddate, iq_date, u_id, u_loginid, u_passwd, u_email, u_name, u_tel, u_address, u_image, u_sex, u_birth, u_type, u_connectid, u_level, u_role, u_use, u_logindate, u_lastchangepasswddate, u_date, g_id, g_name, g_date, u_id, u_loginid, u_passwd, u_email, u_name, u_tel, u_address, u_image, u_sex, u_birth, u_type, u_connectid, u_level, u_role, u_use, u_logindate, u_lastchangepasswddate, u_date from inquiry_tb, user_tb, gym_tb, user_tb")
