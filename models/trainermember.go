...
func (p *TrainermemberManager) GetQuery() string {
    ...
    ret.WriteString("select tm_id, tm_trainer, tm_member, tm_gym, tm_startdate, tm_enddate, tm_status, tm_note, tm_date, u_id, u_loginid, u_passwd, u_email, u_name, u_tel, u_address, u_image, u_sex, u_birth, u_type, u_connectid, u_level, u_role, u_use, u_logindate, u_lastchangepasswddate, u_date, u_id, u_loginid, u_passwd, u_email, u_name, u_tel, u_address, u_image, u_sex, u_birth, u_type, u_connectid, u_level, u_role, u_use, u_logindate, u_lastchangepasswddate, u_date, g_id, g_name, g_date from trainermember_tb, user_tb, user_tb, gym_tb")
