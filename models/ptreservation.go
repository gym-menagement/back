...
func (p *PtreservationManager) GetQuery() string {
    ...
    ret.WriteString("select pr_id, pr_trainer, pr_member, pr_gym, pr_reservationdate, pr_starttime, pr_endtime, pr_duration, pr_status, pr_note, pr_cancelreason, pr_createddate, pr_updateddate, pr_date, u_id, u_loginid, u_passwd, u_email, u_name, u_tel, u_address, u_image, u_sex, u_birth, u_type, u_connectid, u_level, u_role, u_use, u_logindate, u_lastchangepasswddate, u_date, u_id, u_loginid, u_passwd, u_email, u_name, u_tel, u_address, u_image, u_sex, u_birth, u_type, u_connectid, u_level, u_role, u_use, u_logindate, u_lastchangepasswddate, u_date, g_id, g_name, g_address, g_tel, g_user, g_date from ptreservation_tb, user_tb, user_tb, gym_tb")
