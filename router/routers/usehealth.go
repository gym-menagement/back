...
func SetupUsehealthRoutes(group fiber.Router) {
	...
	group.Post("/usehealth", func(c *fiber.Ctx) error {
	...
	group.Post("/usehealth/batch", func(c *fiber.Ctx) error {
		var items_ *[]models.Usehealth
		items__ref := &items_
	...
	group.Put("/usehealth", func(c *fiber.Ctx) error {
		item_ := &models.Usehealth{}
		err := c.BodyParser(item_)
		if err != nil {
		    log.Error().Msg(err.Error())
